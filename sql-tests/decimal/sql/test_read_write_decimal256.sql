...
-- BE exception, special values, simple values, primary key tables, and rounding scenarios.
...
CREATE TABLE ${case_db}.decimal_test_p39_s5 (d1 decimal(39, 5)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s10 (d1 decimal(50, 10)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p65_s15 (d1 decimal(65, 15)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p39_s0 (d1 decimal(39, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s20 (d1 decimal(76, 20)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s40_fe_null (d1 decimal(76, 40)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s50_fe_null (d1 decimal(76, 50)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p40_s35 (d1 decimal(40, 35)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s45 (d1 decimal(50, 45)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p55_s50 (d1 decimal(55, 50)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s0 (d1 decimal(76, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s76 (d1 decimal(76, 76)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p75_s35 (d1 decimal(75, 35)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p60_s30 (d1 decimal(60, 30)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p55_s25 (d1 decimal(55, 25)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p70_s69 (d1 decimal(70, 69)) PROPERTIES("replication_num"="1");
...
-- be throw exception
CREATE TABLE ${case_db}.decimal_test_p41_s8 (d1 decimal(41, 8)) PROPERTIES("replication_num"="1");
INSERT INTO ${case_db}.decimal_test_p41_s8 SELECT 12345678901234567890123456789012345.12345678;
INSERT INTO ${case_db}.decimal_test_p41_s8 SELECT -12345678901234567890123456789012345.12345678;

-- Case 18: precision=43 test
CREATE TABLE ${case_db}.decimal_test_p43_s12 (d1 decimal(43, 12)) PROPERTIES("replication_num"="1");
INSERT INTO ${case_db}.decimal_test_p43_s12 SELECT 1234567890123456789012345678901.123456789012;
INSERT INTO ${case_db}.decimal_test_p43_s12 SELECT -1234567890123456789012345678901.123456789012;

-- Case 19: precision=47 test
CREATE TABLE ${case_db}.decimal_test_p47_s18 (d1 decimal(47, 18)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p52_s25 (d1 decimal(52, 25)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p58_s30 (d1 decimal(58, 30)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p62_s35 (d1 decimal(62, 35)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p68_s40 (d1 decimal(68, 40)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p72_s45 (d1 decimal(72, 45)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p42_s0 (d1 decimal(42, 0)) PROPERTIES("replication_num"="1");
INSERT INTO ${case_db}.decimal_test_p42_s0 SELECT 123456789012345678901234567890123456789012;
INSERT INTO ${case_db}.decimal_test_p42_s0 SELECT -123456789012345678901234567890123456789012;

-- Case 26: precision=48, scale=0
CREATE TABLE ${case_db}.decimal_test_p48_s0 (d1 decimal(48, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p54_s0 (d1 decimal(54, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p60_s0 (d1 decimal(60, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p66_s0 (d1 decimal(66, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p70_s0 (d1 decimal(70, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p45_s40 (d1 decimal(45, 40)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p51_s45 (d1 decimal(51, 45)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p57_s50 (d1 decimal(57, 50)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p63_s55 (d1 decimal(63, 55)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p69_s60 (d1 decimal(69, 60)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p70_s45_fe_null (d1 decimal(70, 45)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p65_s55_fe_null (d1 decimal(65, 55)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p60_s60_fe_null (d1 decimal(60, 60)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p41_s38 (d1 decimal(41, 38)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p46_s42 (d1 decimal(46, 42)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p56_s52 (d1 decimal(56, 52)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p61_s58 (d1 decimal(61, 58)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p67_s63 (d1 decimal(67, 63)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p40_s20 (d1 decimal(40, 20)) PROPERTIES("replication_num"="1");
INSERT INTO ${case_db}.decimal_test_p40_s20 SELECT 11111111111111111111.11111111111111111111;
INSERT INTO ${case_db}.decimal_test_p40_s20 SELECT -11111111111111111111.11111111111111111111;

-- Case 45: All 9s digit test
CREATE TABLE ${case_db}.decimal_test_p45_s22 (d1 decimal(45, 22)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s25 (d1 decimal(50, 25)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p55_s27 (d1 decimal(55, 27)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p39_s19 (d1 decimal(39, 19)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s38 (d1 decimal(76, 38)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p58_s29 (d1 decimal(58, 29)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p39_s0 (d1 decimal(39, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p39_s10 (d1 decimal(39, 10)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p50_s0 (d1 decimal(50, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p50_s25 (d1 decimal(50, 25)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p65_s0 (d1 decimal(65, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p65_s32 (d1 decimal(65, 32)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p76_s0 (d1 decimal(76, 0)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p76_s38 (d1 decimal(76, 38)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p76_s60 (d1 decimal(76, 60)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p76_s76 (d1 decimal(76, 76)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p40_s39 (d1 decimal(40, 39)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p45_s44 (d1 decimal(45, 44)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p55_s1 (d1 decimal(55, 1)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_p70_s35 (d1 decimal(70, 35)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_simple_mixed_p60_s20 (d1 decimal(60, 20)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s76_fe_null (d1 decimal(76, 76)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s30_fe_null (d1 decimal(50, 30)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p40_s35_fe_null (d1 decimal(40, 35)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s10_fe_null (d1 decimal(76, 10)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s5_fe_null (d1 decimal(76, 5)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p60_s58_default_scale (d1 decimal(60, 58)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s48_default_scale (d1 decimal(50, 48)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p45_s43_default_scale (d1 decimal(45, 43)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p40_s38_default_scale (d1 decimal(40, 38)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p35_s33_default_scale (d1 decimal(35, 33)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s75_default_scale (d1 decimal(76, 75)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p70_s68_default_scale (d1 decimal(70, 68)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p55_s53_default_scale (d1 decimal(55, 53)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p76_s76_zero_default (d1 decimal(76, 76)) PROPERTIES("replication_num"="1");
INSERT INTO ${case_db}.decimal_test_p76_s76_zero_default SELECT 0;

-- Case 80: decimal(65, 64) - inserting single digits
CREATE TABLE ${case_db}.decimal_test_p65_s64_single_digit (d1 decimal(65, 64)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p42_s40_boundary_default (d1 decimal(42, 40)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s10_rounding (d1 decimal(50, 10)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s10_overflow (d1 decimal(50, 10)) PROPERTIES("replication_num"="1");
...
CREATE TABLE ${case_db}.decimal_test_p50_s10_both_overflow (d1 decimal(50, 10)) PROPERTIES("replication_num"="1");
...
-- ============================================
-- Part 19: PRIMARY KEY Table Tests with Decimal256
-- ============================================

-- Case 85: PRIMARY KEY table with decimal(39, 0) as value column
CREATE TABLE ${case_db}.decimal_pk_test_p39_s0 (
...
-- Insert basic values
INSERT INTO ${case_db}.decimal_pk_test_p39_s0 VALUES
...
-- Test duplicate key update (should replace old value)
INSERT INTO ${case_db}.decimal_pk_test_p39_s0 VALUES
('user002', 'asset002', '2024-01-02 15:30:00', 2, '2024-01-02', 111111111111111111111111111111111111111);

-- Case 86: PRIMARY KEY table with decimal(50, 10) as value column with multiple key columns
CREATE TABLE ${case_db}.decimal_pk_test_p50_s10 (
    id1 bigint NOT NULL,
...
-- Insert various decimal256 values
INSERT INTO ${case_db}.decimal_pk_test_p50_s10 VALUES
...
-- Test duplicate key update with different decimal values
INSERT INTO ${case_db}.decimal_pk_test_p50_s10 VALUES
...
-- query 86
SELECT user_id, asset_id, shop_id, value FROM ${case_db}.decimal_pk_test_p39_s0 ORDER BY user_id, asset_id, shop_id;

-- query 87
SELECT id1, id2, id3, decimal_value, decimal_nullable, regular_value
FROM ${case_db}.decimal_pk_test_p50_s10
ORDER BY id1, id2, id3;

-- query 88
SELECT decimal_value FROM ${case_db}.decimal_pk_test_p50_s10 WHERE id1 = 2 AND id2 = 'key002' AND id3 = 200;
