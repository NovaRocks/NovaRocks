...
DROP TABLE IF EXISTS ${case_db}.t_tinyint_insert_values;
CREATE TABLE ${case_db}.t_tinyint_insert_values (
  tinyint_col_1 TINYINT NOT NULL,
  tinyint_col_2 TINYINT
);
INSERT INTO ${case_db}.t_tinyint_insert_values VALUES
  (1, 1),
  (1, 2),
  (1, 3),
  (1, 4),
...
FROM ${case_db}.t_tinyint_insert_values
