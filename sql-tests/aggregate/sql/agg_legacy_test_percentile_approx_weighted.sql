...
DROP DATABASE IF EXISTS sql_tests_test_percentile_approx_weighted FORCE;
CREATE DATABASE sql_tests_test_percentile_approx_weighted;
USE sql_tests_test_percentile_approx_weighted;
