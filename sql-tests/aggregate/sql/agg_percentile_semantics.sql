...
DROP TABLE IF EXISTS sql_tests_d06.t_agg_percentile_semantics;
CREATE TABLE sql_tests_d06.t_agg_percentile_semantics (
    id INT,
    v INT,
    w INT,
    d DATE,
...
INSERT INTO sql_tests_d06.t_agg_percentile_semantics VALUES
...
FROM sql_tests_d06.t_agg_percentile_semantics;
