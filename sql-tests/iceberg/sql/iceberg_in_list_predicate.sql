...
CREATE EXTERNAL CATALOG iceberg_in_cat_${uuid0}
PROPERTIES (
  "type" = "iceberg",
...
CREATE DATABASE iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0};
CREATE TABLE iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0}.iceberg_in_tbl_${uuid0} (
  col_str STRING,
  col_int INT
);
INSERT INTO iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0}.iceberg_in_tbl_${uuid0} VALUES
...
SELECT
  COALESCE((
    ...
    FROM iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0}.iceberg_in_tbl_${uuid0}
    WHERE col_int = 2000
...
DROP TABLE iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0}.iceberg_in_tbl_${uuid0} FORCE;
DROP DATABASE iceberg_in_cat_${uuid0}.iceberg_in_db_${uuid0};
DROP CATALOG iceberg_in_cat_${uuid0};
