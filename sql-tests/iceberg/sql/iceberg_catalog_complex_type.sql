...
-- query 1
CREATE DATABASE iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0};
CREATE TABLE iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0}.ice_tbl_${uuid0} (
  name ARRAY<STRUCT<
    user STRING,
    family STRING,
    given ARRAY<STRING>,
...
INSERT INTO iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0}.ice_tbl_${uuid0} VALUES
...
FROM iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0}.ice_tbl_${uuid0};
...
DROP TABLE iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0}.ice_tbl_${uuid0} FORCE;
DROP DATABASE iceberg_cat_${suite_uuid0}.iceberg_db_${uuid0};
