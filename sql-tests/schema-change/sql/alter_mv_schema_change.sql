...
CREATE DATABASE sc_alter_mv_sc_${uuid0};
USE sc_alter_mv_sc_${uuid0};
CREATE TABLE t1 (
    k1 date not null,
...
-- @skip_result_check=true
USE sc_alter_mv_sc_${uuid0};
SHOW ALTER TABLE COLUMN FROM sc_alter_mv_sc_${uuid0} ORDER BY CreateTime DESC LIMIT 1;
...
-- @skip_result_check=true
USE sc_alter_mv_sc_${uuid0};
SHOW ALTER TABLE COLUMN FROM sc_alter_mv_sc_${uuid0} WHERE TableName = 't1' ORDER BY CreateTime DESC LIMIT 1;
