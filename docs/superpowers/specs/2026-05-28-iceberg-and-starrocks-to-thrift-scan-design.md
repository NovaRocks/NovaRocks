...
Parent spec: `docs/superpowers/specs/2026-05-28-connector-first-standalone-scan-design.md` (Stage 3).
Previous slice: `docs/superpowers/plans/2026-05-28-iceberg-codegen-via-connector-begin-scan.md` (merged as PR #202).
