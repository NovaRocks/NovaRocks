...
**Spec:** `docs/superpowers/specs/2026-05-31-iceberg-imv-aggregate-join-logical-cutover-design.md`
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-31-iceberg-imv-aggregate-join-logical-cutover-design.md` only if implementation changes the approved contract
- Modify: `docs/superpowers/plans/2026-05-31-iceberg-imv-aggregate-join-logical-cutover.md` checkbox statuses only while executing
