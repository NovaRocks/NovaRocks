...
2. Verify the umbrella spec needs no further amendment; if implementation diverged anywhere, amend `docs/superpowers/specs/2026-06-10-iceberg-mv-partition-umbrella-design.md` in the same PR.
