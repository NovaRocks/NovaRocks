...
**Spec:** `docs/superpowers/specs/2026-06-01-oq-5-runtime-filter-wiring-design.md` (read §3–§9, §13 first).
...
```bash
git add docs/superpowers/specs/2026-06-01-oq-5-runtime-filter-wiring-design.md
