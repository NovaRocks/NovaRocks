...
**Scope note:** Part A2 of the combined spec `docs/superpowers/specs/2026-06-03-iv3-2-iv3-8-iceberg-metadata-design.md` (IV3-2 §A4 + §A5). Sort-order *DDL* (ALTER … SET SORT ORDER) is not implemented in NovaRocks; §A5 therefore reduces to a resolvability guard, not multi-ALTER evolution management. Prerequisite: Plan 1 (`2026-06-03-iv3-2-snapshot-summary-totals.md`) — same `validation.rs` module, no edit conflicts.
