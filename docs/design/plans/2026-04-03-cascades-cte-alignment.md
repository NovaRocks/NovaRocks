...
**Design Spec:** `docs/design/specs/2026-04-03-cascades-cte-alignment-design.md`
...
Plan complete and saved to `docs/design/plans/2026-04-03-cascades-cte-alignment.md`. Two execution options:
