...
**Source spec:** [docs/design/specs/2026-05-12-managed-lake-delete-design.md](docs/design/specs/2026-05-12-managed-lake-delete-design.md) — see §10 for current-state reality check.
...
Translate WHERE into `DeletePredicateTerms`, encode to `DeletePredicatePb`, dispatch to existing `transactions::delete_data` path. The actual storage layer is fully in place ([see §10.1 of the spec](docs/design/specs/2026-05-12-managed-lake-delete-design.md)) — this milestone is FE-side.
...
Body should reference [docs/design/specs/2026-05-12-managed-lake-delete-design.md](docs/design/specs/2026-05-12-managed-lake-delete-design.md), summarize the milestones, and link to this plan.
...
- **Spec deviation**: if implementation reveals the spec is wrong, prefer updating the spec (in `docs/design/specs/`) over silently diverging.
