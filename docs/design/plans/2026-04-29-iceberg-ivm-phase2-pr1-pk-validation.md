...
**Spec coverage (against `docs/design/specs/2026-04-29-iceberg-ivm-phase2-design.md` §8 and §11 PR-1 line):**
...
Plan complete and saved to `docs/design/plans/2026-04-29-iceberg-ivm-phase2-pr1-pk-validation.md`. Two execution options:
