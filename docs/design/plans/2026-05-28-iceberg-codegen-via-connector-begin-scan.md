...
The parent spec (`docs/design/specs/2026-05-28-connector-first-standalone-scan-design.md`) Stage 3 covers full Iceberg migration. This plan completes only the connector-adapter bootstrap for `IcebergDataFiles`:
