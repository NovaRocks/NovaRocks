...
**Tech Stack:** Rust, tokio (`rt-multi-thread`, `sync`), `async-trait`, arrow `RecordBatch`/`Chunk`, serde config. Spec: `docs/design/specs/2026-06-03-iw1-iw2-async-sink-foundation-design.md`.
