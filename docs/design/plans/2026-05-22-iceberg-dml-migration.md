...
**Spec:** [docs/design/specs/2026-05-22-iceberg-dml-migration-design.md](../specs/2026-05-22-iceberg-dml-migration-design.md)
...
```bash
grep -rn "write-path\|write_path" tests/ docs/ sql-tests/ --include="*.rs" --include="*.md" --include="*.sql" --include="*.toml" 2>/dev/null | grep -v "sql-tests/write-path/\|docs/design/specs/2026-05-22\|docs/design/plans/2026-05-22"
```
