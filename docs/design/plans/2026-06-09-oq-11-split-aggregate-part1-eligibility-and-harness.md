...
> `docs/design/specs/2026-06-09-oq-11-bucket2-diagnosis.md`.
...
This is **Part 1 of OQ-11**. The approved spec (`docs/design/specs/2026-06-09-oq-11-split-aggregate-coverage-parity-design.md`) is a full-parity, six-phase program. This plan covers what is fully specifiable today with exact TDD code:
...
- **Create** `docs/design/specs/2026-06-09-oq-11-bucket2-diagnosis.md` — Task 8 output: the Bucket-2 root-cause work list.
...
**Files:**
- Create: `docs/design/specs/2026-06-09-oq-11-bucket2-diagnosis.md`
...
Create `docs/design/specs/2026-06-09-oq-11-bucket2-diagnosis.md` with one row per query and a verdict drawn ONLY from the observed plans:
...
Each non-empty bucket becomes a follow-up plan under docs/design/plans/.
```
...
```bash
git add docs/design/specs/2026-06-09-oq-11-bucket2-diagnosis.md
