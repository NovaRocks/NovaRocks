...
**Date:** 2026-05-21
**Builds on:**
- `docs/design/specs/2026-04-26-mv-on-iceberg-aggregate-ivm-design.md`
- `docs/design/specs/2026-04-30-aggregate-mv-avg-min-max-design.md` (predecessor: scalar MIN/MAX state with full-refresh fallback)
- `docs/design/specs/2026-05-20-ivm-p1-partition-pruned-touched-group-lookup-design.md` (PR #145 partition-pruned apply path)
