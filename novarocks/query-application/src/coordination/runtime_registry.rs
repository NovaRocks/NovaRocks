...
pub struct LogicalExecutionRuntimeReservation {
...
pub struct InstalledLogicalExecution {
...
#[derive(Debug)]
pub struct LogicalExecutionRegistration {
    registry_id: u64,
    initial_execution: QueryExecutionId,
    generation: u64,
}
...
pub struct LogicalExecutionJoinReceipt {
    registry_id: u64,
    initial_execution: QueryExecutionId,
    generation: u64,
    actor_id: LogicalExecutionActorId,
...
impl LogicalExecutionRuntimeRegistryHandle {
    ...
    pub async fn close_ingress_for_join(
        &self,
        registration: &LogicalExecutionRegistration,
    ) -> Result<(), LogicalExecutionRuntimeRegistryError> {
        self.validate_registry(registration)?;
