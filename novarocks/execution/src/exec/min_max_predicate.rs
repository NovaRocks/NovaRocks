...
impl MinMaxPredicate {
    ...
    pub fn value(&self) -> &MinMaxPredicateValue {
        match self {
    ...
    pub fn op(&self) -> MinMaxPredicateOp {
        match self {
...
impl MinMaxPredicateValue {
    ...
    pub fn as_datetime_micros(&self) -> Option<i64> {
        match self {
            MinMaxPredicateValue::DateTimeMicros(v) => Some(*v),
    ...
    pub fn as_decimal128_scaled(&self, target_scale: i8) -> Option<i128> {
        match self {
