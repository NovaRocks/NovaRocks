...
impl SpillChannelHandle {
    pub fn new() -> Self {
        Self::new_with_limits(1, 1)
    }

    pub fn new_with_limits(num_threads: usize, queue_capacity: usize) -> Self {
        Self {
            inner: Arc::new(SpillChannel {
                executor: Arc::new(SpillIoExecutor::new(num_threads, queue_capacity)),
