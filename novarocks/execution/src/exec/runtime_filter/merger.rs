...
pub struct RuntimeMembershipFilterBuildParam {
    filter_id: i32,
    slot_id: SlotId,
...
impl RuntimeMembershipFilterBuildParam {
    pub fn new(filter_id: i32, slot_id: SlotId, ltype: RuntimeFilterType, join_mode: i8) -> Self {
        Self {
            filter_id,
            slot_id,
            ltype,
...
pub struct RuntimeMembershipBuildOptions {
...
pub struct PartialRuntimeInFilterMerger {
...
pub const MAX_RUNTIME_IN_FILTER_CONDITIONS: usize = 1024;
pub const RUNTIME_FILTER_JOIN_MODE_BROADCAST: i8 = 1;
pub const RUNTIME_FILTER_JOIN_MODE_PARTITIONED: i8 = 2;

#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct RuntimeFilterMergeDropCounters {
    pub in_filters: u64,
    pub membership_filters: u64,
}
...
impl PartialRuntimeInFilterMerger {
    pub fn new(expected_partitions: usize, max_conditions: usize) -> Self {
    ...
    pub fn drain_drop_counters(&self) -> RuntimeFilterMergeDropCounters {
