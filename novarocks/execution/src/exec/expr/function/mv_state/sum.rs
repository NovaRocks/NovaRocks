...
pub fn sum_state_union(a: &[u8], b: &[u8]) -> Result<Vec<u8>, String> {
...
pub fn eval_sum_state_union_arrays(lhs: &ArrayRef, rhs: &ArrayRef) -> Result<ArrayRef, String> {
...
pub fn eval_sum_state_visible_array(
    input: &ArrayRef,
