...
// under the License.
//! PRIMARY_KEYS model reader.
//!
//! PRIMARY_KEYS row visibility is driven by delvec metadata. The low-level
//! scan loop is shared with DUP_KEYS and applies model-specific keep masks.
...
pub(super) fn build_primary_record_batch(
